    ...
    */
    this.messages = {
      ...
      , type: {
        ...
        , digits:     "Este campo debe ser solo dígitos."
      ...
      , regexp:         "Este campo parece ser invalido."
      , min:            "Este campo debe ser mayor o igual a %s."
      , max:            "Este campo debe ser menor o igual a %s."
      , range:          "Este campo debe ser entre %s y %s."
      , minlength:      "Este campo es muy corto.debería tener %s caracteres o más."
      , maxlength:      "Este campo es muy largo. Deberia tener %s cararteres o menos."
      , rangelength:    "La longitud de este campo es invalida. Debe tener una longitud entre %s y %s."
      , mincheck:       "Debe seleccionar al menos %s opciones."
      , maxcheck:       "Debe seleccionar %s opciones o menos."
      , rangecheck:     "Debe seleccionar entre %s y %s opciones."
      , equalto:        "Este campo debe ser el mismo."
    },
