    ...
    */
    this.messages = {
      ...
      , type: {
        ...
        , urlstrict:  "Debe ingresar una url válida"
        , number:     "Debe ingresar un número válido"
        , digits:     "Este campo debe contener solo dígitos"
        , dateIso:    "Debe ingresar una fecha válida (AAAA-MM-DD)"
        , alphanum:   "Este campo debe ser alfanumérico"
        , phone:      "Debe ingresar un número telefónico válido"
        , cellphone:  "Debe ingresar un número celular válido"
        , contrasenia:  "Debe ingresar una contraseña válida (debe contener una letra mayúscula, minúscula y un número)"
      }
      , notnull:        "Este campo no debe estar nulo"
      , notblank:       "Este campo no debe estar vacío"
      , required:       "Este campo es requerido"
      , regexp:         "Este campo parece ser inválido"
      , min:            "Este campo debe ser mayor o igual a %s caracteres"
      , max:            "Este campo debe ser menor o igual a %s caracteres"
      , range:          "Este campo debe ser entre %s y %s caracteres"
      , minlength:      "Este campo es muy corto. Debe tener %s caracteres o más"
      , maxlength:      "Este campo es muy largo. Debe tener %s cararteres o menos"
      , rangelength:    "La longitud de este campo es inválida. Debe tener una longitud entre %s y %s caracteres"
      , mincheck:       "Debe seleccionar al menos %s opciones"
      , maxcheck:       "Debe seleccionar %s opciones o menos"
      , rangecheck:     "Debe seleccionar entre %s y %s opciones"
      , equalto:        "Este campo debe ser el mismo al anterior"
    },
