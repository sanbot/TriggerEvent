				...
				<form data-validate="parsley" method="post" action="/TriggerEvent/Contr_Usuarios">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
							<div class="form-group">
								<%if(!nombre.equals("")){%>
								<button name="REnviarCodigoVer" type="submit" class="btn btn-block defecto" id="Reenviar">Reenviar C&oacute;digo</button>
								<button name="LimpiarDatosUsuario" type="submit" class="btn btn-block defecto" id="LimpiarDatosResUsuario">Limpiar Datos</button>
								<%}else{%>
								<button name="EnviarCodigoVer" type="submit" class="btn btn-block defecto" id="Enviar">Enviar C&oacute;digo</button>
								<%}%>
							</div>
