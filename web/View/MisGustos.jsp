...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="tabbable" id="tabs-880671">
				<ul class="nav nav-tabs">
					<li class="active">
						<a href="#panel-gustos" data-toggle="tab">Mis Gustos</a>
					</li>
					<li>
						<a href="#panel-todos" data-toggle="tab">Todos los Gustos y Ambientes</a>
					</li>
				</ul>
				<div class="tab-content">
					<div class="tab-pane active" id="panel-gustos">
						<br/>
					...
					<div class="tab-pane" id="panel-todos">
						<br/>
                                                <div class="table-responsive">
