...
%>
  ...
  <body>
            ...
            <div class="row">
              ...
              <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="docum" data-rangelength="[6,30]" data-notblank="true" data-required="true" value="<%=Rol%>" readonly/>
               </div>
             </div>
    ...
    <footer>
      ...
      <%if(mensaje.equals("PerfilNoModificado")){%>
